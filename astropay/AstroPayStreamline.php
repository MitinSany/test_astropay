...
class AstroPayStreamline {
    ...
    public $x_login_for_webpaystatus = '***';
    public $x_trans_key_for_webpaystatus = '***';
	...
	public function newinvoice($invoice, $amount, $bank, $country, $iduser, $cpf, $name, $email, $currency=''
        , $return_url='', $confirmation_url='', $description='', $bdate='', $address='', $zip='', $city='', $state=''){
